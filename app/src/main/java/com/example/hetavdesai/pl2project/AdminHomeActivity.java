...
//        nav_username.setText(acct.getDisplayName());
    ...
    public void onActivityOpen() {
        ReservationRecyclerAdapter recyclerAdapter = new ReservationRecyclerAdapter(list, AdminHomeActivity.this);
        RecyclerView.LayoutManager recycleVariable = new LinearLayoutManager(AdminHomeActivity.this);
