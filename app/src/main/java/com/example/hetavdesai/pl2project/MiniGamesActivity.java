...
public class MiniGamesActivity extends AppCompatActivity {
    ...
    TextView detailsReveal1, detailsReveal2, detailsReveal3;
    LinearLayout detailsRevealed1, detailsRevealed2, detailsRevealed3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences settingsCatch = getSharedPreferences("HIGH_SCORE_CATCHBALL",Context.MODE_PRIVATE);
        ...
        SharedPreferences settingsBird = getSharedPreferences("HIGH_SCORE_FLAPPY", Context.MODE_PRIVATE);
...
//        actionbar.setHomeAsUpIndicator(R.drawable.ic_nav_menu);
        ...
        game2_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent2 = new Intent("com.example.hetavdesai.pl2project.MainCatchBallActivity");
                startActivity(intent2);
            }
        });
        ...
        game3_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent3 = new Intent("com.example.hetavdesai.pl2project.MainFlappyActivity");
                startActivity(intent3);
            }
        });
        ...
        GoogleSignInAccount acct = GoogleSignIn.getLastSignedInAccount(MiniGamesActivity.this);
        ...
        detailsReveal1 = findViewById(R.id.details_reveal_1);
        detailsReveal1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        detailsReveal2 = findViewById(R.id.details_reveal_2);
        detailsReveal2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        detailsReveal3 = findViewById(R.id.details_reveal_3);
        detailsReveal3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
