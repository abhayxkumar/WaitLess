...
public class HomeFoodRecyclerAdapter extends RecyclerView.Adapter<HomeFoodRecyclerAdapter.MyHoder> {
    ...
    public HomeFoodRecyclerAdapter(List<FoodClass> list, Context context) {
        this.list = list;
    ...
    public MyHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_food_item, parent, false);
...
//                                holder.addToCartText.setBackgroundColor(R.color.white);
//                                holder.addToCartText.setTextColor(R.color.colorPrimary);
                                holder.addToCart.setEnabled(true);
                                flag[0] = 1;
                            } else {
                                holder.addToCartText.setText("ADDED");
//                                holder.addToCartText.setBackgroundColor(R.color.colorPrimary);
//                                holder.addToCartText.setTextColor(R.color.white);
