...
public class OrderItemRecyclerAdapter extends RecyclerView.Adapter<OrderItemRecyclerAdapter.MyHoder> {
    ...
    public OrderItemRecyclerAdapter(List<OrderItemClass> list, Context context) {
        this.list = list;
