...
import static com.example.hetavdesai.pl2project.ConstantsSwipeButton.BTN_INIT_RADIUS;
import static com.example.hetavdesai.pl2project.ConstantsSwipeButton.BTN_MORPHED_RADIUS;
import static com.example.hetavdesai.pl2project.ConstantsSwipeButton.DEFAULT_SWIPE_DISTANCE;
import static com.example.hetavdesai.pl2project.ConstantsSwipeButton.DEFAULT_TEXT_SIZE;
import static com.example.hetavdesai.pl2project.ConstantsSwipeButton.MORPH_ANIM_DURATION;
import static com.example.hetavdesai.pl2project.UiUtilsSwipeButton.animateFadeHide;
import static com.example.hetavdesai.pl2project.UiUtilsSwipeButton.animateFadeShow;
import static com.example.hetavdesai.pl2project.UiUtilsSwipeButton.dpToPx;
...
public class ProSwipeButton extends RelativeLayout {
    ...
    //// TODO: 26/03/19 Add touch blocking
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            bgColorInt = a.getColor(R.styleable.ProSwipeButton_bg_color, ContextCompat.getColor(context, R.color.colorPrimary));
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (!enabled) {
            gradientDrawable.setColor(ContextCompat.getColor(context, R.color.abc_input_method_navigation_guard));
            updateBackground();
            this.setAlpha(0.5f);
        } else {
