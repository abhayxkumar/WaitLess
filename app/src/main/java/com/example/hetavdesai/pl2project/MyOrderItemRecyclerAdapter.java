...
public class MyOrderItemRecyclerAdapter extends RecyclerView.Adapter<MyOrderItemRecyclerAdapter.MyHoder> {
    ...
    public MyOrderItemRecyclerAdapter(List<OrderItemClass> list, Context context) {
        this.list = list;
    ...
    public MyHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_order_item_item, parent, false);
